...
class CourseClassAPITests(APITestCase):
    ...
    def test_course_classes_can_be_searched_by_term_type(self):
        other_term = Term.objects.create(
            start_date="2027-01-01",
            end_date="2027-03-31",
            term_type="intensive",
    ...
    def test_course_classes_can_be_searched_by_teacher_first_name(self):
        matching_teacher = User.objects.create_user(
            username="matching_search_teacher",
            first_name="Vahid",
            last_name="Vahedi",
            role=User.Role.TEACHER,
        ...
        response = self.client.get(
            self.url,
            {"search": matching_teacher.first_name},
        )
